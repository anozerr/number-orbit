...
static var _tables: Dictionary = {
	...
	"ru": {
		...
		"hint.body": "Потратьте %d 💡, чтобы открыть следующий верный ход.",
		"hint.balance": "Баланс: %d 💡",
		"hint.balance_short": "Баланс: %d / %d 💡",
		...
		"complete.reward": "Награда: +%d 💡  •  Баланс: %d",
		"complete.reward_claimed": "Лучшая награда уже получена  •  Баланс: %d",
		...
		"hint.insufficient": "Недостаточно 💡 для подсказки.",
		...
		"tut.multiply.after": "Порядок тоже важен.",
